...
typedef struct ToplevelWindow {
  ...
  int peistreeview_selectionButton;
  
  /** The currently selected component when creating context menus */
  char menuSelectedComponent[256];
...
extern char guiXMLfilename[512];
...
void repopulateEcologyview(ToplevelWindow *);
void repopulateAllEcologyviews();

void topologyUpdateView(ToplevelWindow *);
void tupleviewPageActivated();
void ecologyviewPageActivated(ToplevelWindow *);
