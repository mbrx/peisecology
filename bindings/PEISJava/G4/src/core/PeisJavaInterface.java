...
public interface PeisJavaInterface extends Library {
	...
	public static final String version = "v0.4.4.a";
	 ...
	 */
	public PeisTuple peisk_getTuple(String key, int owner, IntByReference len, PointerByReference ptr, boolean flags);
	 ...
	 */
	public PeisTuple peisk_getTuples(String key, IntByReference owner, IntByReference len, PointerByReference ptr, IntByReference handle, boolean flags);
	 ...
	 */
	public PeisTuple peisk_getIndirectTuple(String metaKey, int metaOwner, IntByReference len, PointerByReference ptr, boolean flags);
