...
public class PeisJavaMT implements PeisJavaInterface {
	...
	public static PeisTuple peisjava_getTuple(String key) {
		synchronized(peiskCriticalSection) {
			PeisTuple ret = INSTANCE.peisk_getTuple(key, INSTANCE.peisk_peisid(), new IntByReference(), new PointerByReference(), true);
			return ret;
		}
	}
	
	/**
	 * Get the data in a tuple in the form of a String.  The owner of the tuple must
	...
	public static String peisjava_getStringTuple(String name) {
    	...
    	synchronized(peiskCriticalSection) {
    		if (INSTANCE.peisk_tupleExists(name))
    			tup = INSTANCE.peisk_getTuple(name, INSTANCE.peisk_peisid(), new IntByReference(), value, true);
    	}
	...
	public static String peisjava_getStringTuple(int owner, String name) {
    	...
    	PeisTuple tup = null;
    	synchronized(peiskCriticalSection) {
    		tup = INSTANCE.peisk_getTuple(name, owner, new IntByReference(), value, true);
    	}
    	if (tup != null && value.getValue() != null)
    		return value.getValue().getString(0);
		return null;
	...
	*/
	...
	public static PeisTuple peisjava_getIndirectTuple(String metaKey, int metaOwner) {
		synchronized(peiskCriticalSection) {
			return INSTANCE.peisk_getIndirectTuple(metaKey, metaOwner, new IntByReference(), new PointerByReference(), true);
		}
	}
	...
	public static PeisTuple peisjava_getIndirectTuple(String metaKey, int metaOwner,
		...
		synchronized(peiskCriticalSection) {
			return INSTANCE.peisk_getIndirectTuple(metaKey, metaOwner, len, ptr, flags);
		}
	}
	...
	public static PeisTuple peisjava_getTuple(String key, int owner, IntByReference len,
			PointerByReference ptr, boolean flags) {
		synchronized(peiskCriticalSection) {
